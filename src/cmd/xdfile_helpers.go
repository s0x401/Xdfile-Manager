...
func xdfileHelpText() string {
	return strings.Join([]string{
		...
		"Shift+Up/Down    toggle the current file selection and jump up or down",
		"Shift+Left/Right toggle the current file and all files above or below it",
		"Esc              clear the current multi-selection",
		"Mouse            click to focus/select, double click to open, right click opens a context menu, wheel to scroll",
		"",
