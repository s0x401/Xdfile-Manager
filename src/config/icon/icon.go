...
var Icons = map[string]Style{
	...
	"audio":        {Icon: "\uf001", Color: "#f08a5d"},     // Printable Rune : ""
	...
	"graphql":      {Icon: "\ue662", Color: "#ff82b2"},     // Printable Rune : ""
	...
	"hx":           {Icon: "\ue666", Color: "#ff9d5c"},     // Printable Rune : ""
	"ics":          {Icon: "\uf073", Color: "#f1c40f"},     // Printable Rune : ""
	"image":        {Icon: "\uf1c5", Color: "#5bc0eb"},     // Printable Rune : ""
	...
	"jenkinsfile":  {Icon: "\ue767", Color: "#f2b134"},     // Printable Rune : ""
	...
	"lua":          {Icon: "\ue620", Color: "#4da3ff"},     // Printable Rune : ""
	...
	"npmignore":    {Icon: "\ue71e", Color: "#ff9d66"},     // Printable Rune : ""
	...
	"ppt":          {Icon: "\uf1c4", Color: "#ffb65a"},     // Printable Rune : ""
	...
	"styl":         {Icon: "\ue600", Color: "#7a9cff"},     // Printable Rune : ""
	...
	"video":        {Icon: "\uf03d", Color: "#b388ff"},     // Printable Rune : ""
	"vbs":          {Icon: "\uf17a", Color: "#36cfc9"},     // Printable Rune : ""
	...
	"zip":          {Icon: "\uf410", Color: "#f3a43b"},     // Printable Rune : ""
}
...
var Folders = map[string]Style{
	...
	"xdfile": {Icon: "\U000f069d", Color: "#FF6F00"}, // Printable Rune : "󰚝"
}
